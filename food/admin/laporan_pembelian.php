    ...
    <div class="row">
        ...
        <div class="col-md-3">
            ...
            <select name="status" id="" class="form-control">
                ...
                <option value="Pesanan Diterima" <?php echo $status == "Pesanan Diterima" ? "selected" : ""; ?>>Pesanan Makanan Diterima</option>
                <option value="Makanan Diterima" <?php echo $status == "Makanan Diterima" ? "selected" : ""; ?>>Makanan Diterima Pelanggan</option>
