      ...
      <div class="row">
        <div class="col-md-8">
          <div class="form-group">
            ...
            <textarea name="alamat_pengiriman" placeholder="Masukan Alamat Lengkap pengiriman" class="form-control" required></textarea>
          </div>
        </div>
        <div class="col-md-4">
          <label> Pilih Mode Bayar</label>
          <select name="id_mode" class="form-control" required>
