            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <?php if ($detail["stok_produk"] == 0) { ?>
                        <h5 class="alert alert-danger">Maaf Stok Kosong</h5>
                    <?php } else { ?>
                        <form method="POST">
                            <div class="form-group">
                                <div class="input-group">
                                    <label>Jumlah</label>
                                    <input type="number" min="1" value="1" class="form-control" name="jumlah" max="<?php echo $detail["stok_produk"]; ?>" required>
                                </div>
